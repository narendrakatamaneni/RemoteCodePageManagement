...
namespace FileSystem
{
  ...
  public:
	...
	static std::string getValueInQuotes(const std::string& src);
	static std::string getValueQuotes(const std::string& src);
	static std::string getDependencyPath(const std::string& src);
