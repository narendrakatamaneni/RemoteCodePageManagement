...
namespace MsgPassingCommunication
{
  ...
  public:
    Translater();
    void listen(CsEndPoint^ ep, String ^ rcvPath, String^ sndPath);
  ...
  void Translater::listen(CsEndPoint^ ep, String ^ rcvPath, String^ sndPath)
  {
    ...
    pComm->start(Sutils::MtoNstr(rcvPath),Sutils::MtoNstr(sndPath));
    delete pFactory;
  }
